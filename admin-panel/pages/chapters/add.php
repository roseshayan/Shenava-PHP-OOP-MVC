...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        ...
        try {
            ...
            $fileSize = $_FILES['audio_file']['size'] ?? 0;
            ...
            if ($db->execute()) {
                ...
                header("Location: ../books/chapters.php?book_id=$bookId");
                exit;
            } else {
...
$pageTitle = "افزودن فصل جدید - شنوا";
?>
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                ...
                <div class="btn-toolbar mb-2 mb-md-0">
                    <a href="../books/chapters.php?book_id=<?php echo $bookId; ?>" class="btn btn-outline-secondary">
                    ...
                    <form method="POST" enctype="multipart/form-data" id="chapterForm">
                        <div class="row g-4">
                            <div class="col-md-8">
                                <div class="card">
                                    <div class="card-header">
                                        <h5 class="card-title mb-0">اطلاعات فصل</h5>
                                    </div>
                                    <div class="card-body">
                                        <div class="mb-3">
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="number"
                                                           ...
                                                           min="1"
                                                           required
                                                           placeholder="مثلا: 3600 برای 1 ساعت">
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="card mb-4">
                                    <div class="card-header">
                                        <h5 class="card-title mb-0">فایل صوتی</h5>
                                    </div>
                                    <div class="card-body">
                                        <div class="mb-3">
                                            ...
                                            <input type="file"
                                                   ...
                                                   accept="audio/*"
                                                   required>
                                            <div class="form-text">فرمت‌های مجاز: MP3, WAV, M4A - حداکثر سایز: 50MB
                                            </div>
                                        </div>
                        ...
                        <div class="row mt-4">
                            <div class="col-12">
                                <div class="d-flex justify-content-end gap-2">
                                    <a href="../books/chapters.php?book_id=<?php echo $bookId; ?>"
    ...
    $(document).ready(function () {
        ...
        $('#audio_file').on('change', function (e) {
            ...
            if (file) {
                ...
                $('#fileInfo').text(`فایل انتخاب شده: ${file.name} (${fileSize} MB)`);
                $('#audioInfo').show();
            }
        });
